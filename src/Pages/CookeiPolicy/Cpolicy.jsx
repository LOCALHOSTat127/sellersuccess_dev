    ...
    <section className="cookie_policy">
      <div className="inner">
        <h1 className="page_title">
          Cookie Policy for SellerSuccess -: Business Accounting &amp; DIgital
          Marketing
        </h1>
        <p>
          This is the Cookie Policy for SellerSuccess -: Business Accounting
          &amp; DIgital Marketing, accessible from https://sellersuccess.in
        </p>
        <p>
        ...
        <ul>
          <li>Email: sellersuccess.business@gmail.com</li>
          <li>By visiting this link: https://sellersuccess.in </li>
          <li>Phone: 7852099185, 9649460626</li>
        </ul>
      </div>
    </section>
  );
