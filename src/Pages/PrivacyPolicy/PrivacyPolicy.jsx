  ...
  return (
    <section className="privacy_policy">
      <div className="inner">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to SellerSuccess - Marketing &amp;
              Finance, 95,Mohan nagar, Brhampuri,Jaipur,Rajasthan (302002).
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to SellerSuccess , accessible from{" "}
              <a
                href="https://sellersuccess.in"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://sellersuccess.in
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: sellersuccess.business@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://sellersuccess.in/contact"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://sellersuccess.in/contact
              </a>
            </p>
          </li>
          <li>
            <p>By phone number: 7852099185, 9649460626</p>
          </li>
          <li>
            <p>By mail: 95,Mohan nagar, Brhampuri,Jaipur,Rajasthan (302002)</p>
          </li>
        </ul>
      </div>
    </section>
